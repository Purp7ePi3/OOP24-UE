...
public class PuzzleRoom4 extends Room implements PuzzleRoom {
    private boolean puzzleSolved = false;

    public PuzzleRoom4(final List<Door> doors, final GameState gameState) {
    ...
    public void updatePuzzleLogic(final KeyHandler keyHandler) {
        ...
        if (!getDoors().isEmpty()) {
            ...
            if (playerX == 0 && playerY == 0 && keyHandler.interactPressed) {
                ...
                gameState.updateDoorState(4, true); // 4 is the index of this puzzle room
